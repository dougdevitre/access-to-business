...
Hire when:
- You have a role that's blocking revenue or product
...
**Do not hire for ops, finance, or HR until you have real scale.**
...
```
Title: [Specific, not vague — "Head of Sales" not "Growth Person"]

We're looking for: [2 sentences — what they'll do and why it matters]

You'll be great if you:
- [Required: specific, observable skill or experience]
...
## Equity Ranges (Seed Stage Benchmarks)

| Role | Typical Equity Range |
|------|---------------------|
| Co-founder | 10–50% |
| CTO (early, pre-funding) | 1–5% |
| First engineer | 0.5–2% |
| VP Engineering (post-seed) | 0.5–1% |
| VP Sales | 0.5–1% |
| First salesperson | 0.1–0.5% |
| Design / product | 0.25–1% |
| Advisor | 0.1–0.25% |

Source: Holloway Guide to Equity Compensation, AngelList benchmarks.  
These are ranges — adjust based on stage, cash comp tradeoff, and candidate seniority.
...
- Engineer: Code review or take-home challenge (<2 hours)
...
### Before You Start
- Agree on equity in writing (see legal-formation.md)
- Align on: vision, risk tolerance, time commitment, salary expectations, decision authority
- Define what happens if one founder wants to leave

### Healthy Co-Founder Habits
- Weekly 1:1 — not just work, how are you doing
- Quarterly "state of the partnership" conversation
- Clear ownership lanes — avoid stepping on each other
- Disagree and commit — once decided, full support

### Warning Signs
- Avoiding difficult conversations
- Asymmetric effort without acknowledgement
- Diverging on vision without resolving it
- Money stress (different personal financial situations)

**Address co-founder conflict early. Most startup failures trace back here.**
...
- Customer calls (even if not their role)
- 1:1 with founder — learn context
...
```
Value: [Name]
What it looks like in practice: [Specific behavior]
What violates it: [Specific counter-example]
```
